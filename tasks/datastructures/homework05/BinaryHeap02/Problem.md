...
* `Insert(key: int)` - Insert the key at the next position available, once placed there, check to see if it should be swapped with the parent.
...
You can test your code by running `dotnet test` within the solution directory.
